...
export class DashboardCardService {
  ...
  public get(): Observable<Array<DashboardCard>> {
    return this._client.get<{ dashboardCards: Array<DashboardCard> }>(`${this._baseUrl}api/dashboard-card`)
      .pipe(
  ...
  public getById(options: { dashboardCardId: string }): Observable<DashboardCard> {
    return this._client.get<{ dashboardCard: DashboardCard }>(`${this._baseUrl}api/dashboard-card/${options.dashboardCardId}`)
      .pipe(
  ...
  public delete(options: { dashboardCard: DashboardCard }): Observable<void> {
    return this._client.delete<void>(`${this._baseUrl}api/dashboard-card/${options.dashboardCard.dashboardCardId}`);
  }

  public create(options: { dashboardCard: DashboardCard }): Observable<{ dashboardCardId: string  }> {    
    return this._client.post<{ dashboardCardId: string }>(`${this._baseUrl}api/dashboard-card`, { dashboardCard: options.dashboardCard });
  }
